...
import { AreaOfSpecialityComponent } from './shared/layout/profile/area-of-speciality.component';
import { TherapistUpcomingAppointmentsComponent } from './shared/layout/topbar/therapist-upcoming-appointments/therapist-upcoming-appointments.component';
...
@NgModule({
    declarations: [
        ...
        AreaOfSpecialityComponent,
        TherapistUpcomingAppointmentsComponent
    ],
    imports: [
        CommonModule,
        FormsModule,
