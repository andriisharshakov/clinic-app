...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.FindPtServiceProxy,
        ApiServiceProxies.TherapistAppointmenServiceProxy,
        ApiServiceProxies.PatientAppointmentServiceProxy,
        ApiServiceProxies.VideoCallServiceProxy,
        { provide: RefreshTokenService, useClass: ZeroRefreshTokenService },
        { provide: AbpHttpConfigurationService, useClass: ZeroTemplateHttpConfigurationService },
        { provide: HTTP_INTERCEPTORS, useClass: AbpHttpInterceptor, multi: true },
        ApiServiceProxies.LibraryEntryServiceProxy,
        ApiServiceProxies.KeywordServiceProxy,
        ApiServiceProxies.MyPatientsServiceProxy,
        ApiServiceProxies.GymServiceProxy,
