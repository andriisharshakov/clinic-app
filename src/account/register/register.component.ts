...
export class RegisterComponent extends AppComponentBase implements OnInit {
    ...
    patientRole: string = AppConsts.roleManagement.patientRoleName;
    therapistRole: string = AppConsts.roleManagement.therapistRoleName;
    ...
    constructor(
        ...
        super(injector);
        this.model.role = this.patientRole;
    }
